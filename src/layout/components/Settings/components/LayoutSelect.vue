<template>
  <div class="flex flex-wrap justify-around w-full h-12">
    <el-tooltip :content="$t('layout.left')" placement="bottom">
      <div
    ...
    <el-tooltip :content="$t('layout.top')" placement="bottom">
      <div
    ...
    <el-tooltip :content="$t('layout.mix')" placement="bottom">
      <div
