  ...
  <div class="app-container">
    <el-card class="box-card" shadow="always">
      ...
      <el-row class="card-content">
        <p>本文从0到1描述了搭建一个管理前端项目模板的基本步骤，其中包括pnpm、vue3、vite5、Element-Plus、Vue-Router、Pinia、Axios等前端主流技术栈。希望通过本项目能够让大家在学习Vue3等技术栈时少花些时间，少走些弯路。</p>
      </el-row>
    </el-card>
    <el-card class="box-card" shadow="always">
      <template #header>
    ...
    <el-collapse v-model="activeNames" @change="handleChange">
      <el-collapse-item title="项目初始化" name="1">
        ...
        <div class="p-2">
          ...
          请参考Pinia的文档: <a href="https://pinia.vuejs.org/" target="_blank">https://pinia.vuejs.org/</a> 和stores目录下的代码
        </div>
        <div class="p-2">
          7. 整合Vue-Router<br/>
          Vue-Router 是 Vue 的路由管理器。<br/>
          请参考Vue-Router的文档: <a href="https://router.vuejs.org/" target="_blank">https://router.vuejs.org/</a>" 和stores目录下的代码
        </div>
        <div class="p-2">
