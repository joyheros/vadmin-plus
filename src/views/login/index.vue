<template>
  <div class="login-container">
    ...
    <!-- 登录表单 -->
    <el-card class="!border-none !bg-transparent !rounded-4% w-110 <sm:w-85">
      ...
      <el-form ref="loginFormRef" :model="loginData" :rules="loginRules" class="login-form">
        ...
        <el-form-item prop="captchaCode">
          <div class="flex-y-center w-full">
            <svg-icon icon-class="shield" class="mx-2" />
            <el-input
        ...
        <div class="w-full h-[35px] flex items-center">
          <el-text class="mx-1" type="info">{{ $t('login.noAccount') }}</el-text>
          <el-link type="primary" href="#">&nbsp;{{ $t('login.register') }}</el-link>
        </div>
        <div class="w-full h-[40px]">
          ...
          <div class="text-center">
            <svg-icon icon-class="wechat" class="mx-5" size="1.8em" />
            <svg-icon icon-class="alipay" class="mx-5" size="2em" />
            <svg-icon icon-class="github" class="mx-5" size="1.8em" />
          </div>
        </div>
      </el-form>
    </el-card>
