<script setup>
import { getOperationLog, deleteOperationLog } from '@/api/monitor/operation'
  ...
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-container">
      ...
      >
        ...
        <el-table-column label="操作概要" prop="summary" width="200" />
        <el-table-column label="操作IP" prop="netip" width="130" />
        <el-table-column label="操作地点" prop="address" width="180" />
        ...
        <el-table-column label="操作时间" prop="operateTime" min-width="100" />
      </el-table>
